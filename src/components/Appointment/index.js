...
export default function Appointment(props) {
  ...
  function save(name, interviewer, remainingSpots) {
    ...
    props
    .bookInterview(props.id, interview, remainingSpots)
  ...
  return (
    <article className="appointment" data-testid="appointment">
      ...
      <div>
        ...
        {mode === CREATE && <Form name={props.name} interviewer={props.interviewer} interviewers={props.interviewers} onSave={save} onCancel={() => back()} isCreate={true}/>}
        {mode === SHOW && (
          <Show
